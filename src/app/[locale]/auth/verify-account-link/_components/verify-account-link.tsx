...
import { verifyAccountLink } from "@/lib/api/customer-auth";

type State = "verifying" | "success" | "error";

export function VerifyAccountLink({ locale }: { locale: Locale }) {
  const t = dictionaries[locale].auth.verifyLink;
  ...
  // Verify once on mount. The backend adds the CUSTOMER role and returns the
