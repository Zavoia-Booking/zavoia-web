...
// ─────────────────────────────────────────────────────────────
window.ZV_PRO_TODAY = { year: 2026, month: 5 /* June, 0-indexed */, day: 2 };
...
(function () {
  ...
  window.ZV_PRO_DISABLED_DATES = disabled;
  window.ZV_PRO_SLOTS = slots;
  window.ZV_PRO_SOLD_SLOTS = sold;
  window.ZV_PRO_DAY_BUSY = busy;
})();
